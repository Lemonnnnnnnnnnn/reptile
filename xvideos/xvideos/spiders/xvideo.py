...
import logging
import json
from common import random_chose_node
from ..items import XvideosItem
...
class XvideoSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        with open(r'D:\technology\python\reptile\xvideos\xvideos\cookie.txt', 'r') as f:
            cookieStr = f.read()
    ...
    def detailParse(self, response):
        ...
        name = response.xpath('//*[@id="main"]/h2/text()').get()
        ...
        yield scrapy.Request(url=requestUrl, headers=headers, method='POST',
                             callback=self.download, meta={'name': name})
